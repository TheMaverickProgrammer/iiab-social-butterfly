...
if( !defined( 'THEME_ADMIN' ) )
	define( 'THEME_ADMIN' , NULL );
	
if( !defined('SOCIALBUTTERLY_PLUGIN_URL') )
	define( 'SOCIALBUTTERLY_PLUGIN_URL' , plugin_dir_url( __FILE__ ) );
...
<div class="wrap" id="truethemes_container">
  ...
  <form action="" enctype="multipart/form-data" id="ofform">
    <div id="header">
      <div class="logo">
        <h2>Image In A Box Theme Options</h2>
      </div>
    ...
    <img style="display:none;" src="<?php echo SOCIALBUTTERLY_PLUGIN_URL ?>/images/wpspin_light.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="Working..." />
...
function of_style_only() {
	wp_enqueue_style('admin-style', SOCIALBUTTERLY_PLUGIN_URL.'/admin-style.css');
	wp_enqueue_style('color-picker', SOCIALBUTTERLY_PLUGIN_URL.'/colorpicker.css');
	$color = get_user_option('admin_color');
	if ($color == "fresh")
		{
		wp_enqueue_style('admin-style-grey', SOCIALBUTTERLY_PLUGIN_URL.'/admin-style-grey.css');
		wp_enqueue_style('color-picker', SOCIALBUTTERLY_PLUGIN_URL.'/colorpicker.css');
		}
}
...
function of_load_only() {
	...
	wp_register_script('jquery-input-mask', SOCIALBUTTERLY_PLUGIN_URL.'/js/jquery.maskedinput-1.2.2.js', array( 'jquery' ));
	wp_enqueue_script('jquery-input-mask');
	wp_enqueue_script('color-picker', SOCIALBUTTERLY_PLUGIN_URL.'/js/colorpicker.js', array('jquery'));
	wp_enqueue_script('ajaxupload', SOCIALBUTTERLY_PLUGIN_URL.'/js/ajaxupload.js', array('jquery'));
